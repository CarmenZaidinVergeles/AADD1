 ...
 */
public class OrigenDeDatosContactos {
    ...
    public static List<Contacto> getListaCompleta(Context contexto){
            ArrayList<Contacto> nombres = (ArrayList<Contacto>) OrigenDeDatosContactos.getListaContactos(contexto);
            for(Contacto c : nombres){
                c.setlistTelf(OrigenDeDatosContactos.getListaTelefonos(contexto, c.getId()));
            }
